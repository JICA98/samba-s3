...
| `BCUS98174-The-Last-of-Us.md` | The Last of Us — **in-game pass** on OnePlus 13R (Adreno 750 / Turnip 26.3). Boots, builds SPU cache, passes main menu, creates save, and plays opening prologue cutscenes and narrative in-game at solid 30.0 FPS. |
| `BCUS98174/qualcomm-adreno/adreno-750/README.md` | The Last of Us device record — historical fail updated to 2026-09-13 in-game pass. |
