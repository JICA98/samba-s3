...
object SettingsBackendAudit {
    ...
    val knownSettings: List<KnownSetting> = listOf(
        ...
        KnownSetting("Video@@Write Depth Buffer", "bool"),
        KnownSetting("Video@@Read Depth Buffer", "bool"),
        KnownSetting("Video@@Handle RSX Memory Tiling", "bool"),
        KnownSetting("Video@@Strict Rendering Mode", "bool"),
        KnownSetting("Video@@Relaxed ZCULL Sync", "bool"),
        KnownSetting("Video@@Driver Wake-Up Delay", "int"),
